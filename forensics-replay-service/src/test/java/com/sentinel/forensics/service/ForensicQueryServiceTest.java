    ...
    void verifyReplayHash_usesSameSnapshotRulesAsReplaySession() {
        ...
        EventStoreClient client = new EventStoreClient() {
            ...
            public List<EventDTO> fetchEvents(UUID sid) {
                return List.of(
                        event(UUID.fromString("00000000-0000-0000-0000-000000000001"), sid, 1000L, "BLOCK_DELETE",
                                "DELETE", EventType.ACCESS),
                        event(UUID.fromString("00000000-0000-0000-0000-000000000002"), sid, 2000L, "ALLOW_ALL",
                                "GET", EventType.LOGIN));
            }
